  ...
  return (
    <div className='mt-12'>
      ...
      {earningData.map((item) => (
        ...
        <p className='flex items-cener gap-2 text-gray-600 hover:drop-shadow-xl'>
          <span>
            <RxDotFilled />
          </span>
          <span>Expense</span>
        ...
        <p className='flex items-cener gap-2 text-green-400 hover:drop-shadow-xl'>
          <span>
            <RxDotFilled />
          </span>
          <span>Budget</span>
        ...
        <div>
          <p>
            <span className='text-3xl font-semibold'>$43,235</span>
        ...
        <div className='mt-8'>
          <p>
            <span className='text-3xl font-semibold'>$50,869</span>
          </p>
          <p className='text-gray-500 mt-1'>
          Expense
          </p>
